...
export const en = {
  ...
  import: {
    ...
    linkPlaceholder: 'Paste any recipe link…',
    linkSupports: 'Works with Instagram, TikTok, YouTube & websites.',
    snap: 'Snap a photo',
  ...
  grocery: {
    ...
    clearListBody: 'Remove your own items and check everything off?',
    ...
    removeBody: 'Remove “{name}” from your list?',
